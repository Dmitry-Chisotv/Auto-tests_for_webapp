...
def test_step1():
    x_selector1 = """//*[@id="app-container"]/flt-glass-pane//form[4]/input[2]"""
    input1 = site.find_element('xpath', x_selector1)
    input1.send_keys('pfinquality')
    x_selector2 = """//*[@id="app-container"]/flt-glass-pane//form[4]/input[2]"""
    input2 = site.find_element('xpath', x_selector2)
    input2.send_keys('3578951')

    btn_selector = """//*[@id="app-container"]/flt-glass-pane"""
    btn = site.find_element('xpath', btn_selector)
    btn.click()

    # x_selector3 = """document.querySelector("head > meta:nth-child(6)")"""
    # err_label = site.find_element('xpath', x_selector3)
    # # err_label = site.find_element('xpath', selector_error)
    # # print(err_label.text)
    # assert err_label.text == 'BIOCARD LOGISTICS DASHBOARD', "НЕ прошел позитивную проверку"
    #
    # input1.clear()
    # input2.clear()
